...
use AvanamBuilder\Core\Base\App;
use AvanamBuilder\Core\Base\Document;
use AvanamBuilder\Core\Responsive\Files\Frontend as FrontendFile;
use AvanamBuilder\Core\Files\CSS\Global_CSS;
use AvanamBuilder\Core\Files\CSS\Post as Post_CSS;
use AvanamBuilder\Core\Files\CSS\Post_Preview;
...
class Frontend extends App {
	...
	public function register_styles() {
		...
		if ( $has_custom_file ) {
			...
			$frontend_file_url = AVANAM_BUILDER_ASSETS_URL . 'css/' . $frontend_file_name;
		}
		...
		Wp_Helper::wp_register_style(
			...
			$frontend_file_url,
			[],
			$has_custom_file ? null : AVANAM_BUILDER_VERSION
		);
	...
	public function get_init_settings() {
		...
		$settings = [
			...
			'urls' => [
				'assets' => AVANAM_BUILDER_ASSETS_URL,
			],
		];
