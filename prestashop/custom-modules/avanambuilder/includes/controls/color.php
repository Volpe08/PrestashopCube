...
class Control_Color extends Base_Data_Control {
	...
	public function enqueue() {
		...
		Wp_Helper::wp_register_style(
			'wp-color-picker',
			AVANAM_BUILDER_ASSETS_URL . 'lib/wp-color-picker/wp-color-picker.min.css',
			[],
			'1.0.7'
		);
		...
		Wp_Helper::wp_register_script(
			'wp-iris',
			AVANAM_BUILDER_ASSETS_URL . 'lib/wp-color-picker/iris.min.js',
			[
				'draggable',
				'slider',
				'touch'
		...
		Wp_Helper::wp_register_script(
			'wp-color-picker',
			AVANAM_BUILDER_ASSETS_URL . 'lib/wp-color-picker/wp-color-picker.min.js',
			[
				'wp-iris',
			],
			'',
		...
		Wp_Helper::wp_register_script(
			...
			AVANAM_BUILDER_ASSETS_URL . 'lib/wp-color-picker/wp-color-picker-alpha' . $suffix . '.js',
			[
				'wp-color-picker',
			],
			'2.0.1',
