...
class Group_Control_Background extends Group_Control_Base {
	...
	public function init_fields() {
		...
		$fields['xpos'] = [
			...
			'required' => true,
			'device_args' => [
				Controls_Stack::RESPONSIVE_LAPTOP => [
					'selectors' => [
						'{{SELECTOR}}' => 'background-position: {{SIZE}}{{UNIT}} {{ypos_laptop.SIZE}}{{ypos_laptop.UNIT}}',
					],
					'condition' => [
						'background' => [ 'classic' ],
						'position_laptop' => [ 'initial' ],
					],
				],
		...
		$fields['ypos'] = [
			...
			'device_args' => [
				Controls_Stack::RESPONSIVE_LAPTOP => [
					'selectors' => [
						'{{SELECTOR}}' => 'background-position: {{xpos_laptop.SIZE}}{{xpos_laptop.UNIT}} {{SIZE}}{{UNIT}}',
					],
					'condition' => [
						'background' => [ 'classic' ],
						'position_laptop' => [ 'initial' ],
