...
use AvanamBuilder\Core\Base\Document;
use AvanamBuilder\Core\Editor\Editor;
use AvanamBuilder\DB;
use AvanamBuilder\Core\Settings\Manager as SettingsManager;
use AvanamBuilder\Core\Settings\Page\Model;
use AvanamBuilder\Modules\Library\Documents\Library_Document;
...
class Source_Local extends Source_Base {
	...
	public function get_items( $args = [] ) {
		...
		foreach ( $templates_local as $post ) {
			$templates[] = $this->get_item( $post['id_avanam_builder_template'] );
		}
	...
	public function save_item( $template_data ) {
		...
		$template = new \AvanamBuilderTemplate();
	...
	public function get_item( $template_id ) {
		$post = new \AvanamBuilderTemplate( $template_id );
	...
	public function get_data( array $args ) {
		...
		$template = new \AvanamBuilderTemplate( $template_id );
	...
	private function prepare_template_export( $template_id ) {
		...
		return [
			'name' => 'avanambuilder-' . $template_id . '-' . date( 'Y-m-d' ) . '.json',
