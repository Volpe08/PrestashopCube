...
<script type="text/template" id="tmpl-elementor-template-library-get-pro-button">
	<a class="elementor-template-library-template-action elementor-button elementor-button-go-pro" href="<?php echo Wp_Helper::get_exit_to_dashboard( 'AdminAvanamBuilderLicense' ); ?>" target="_blank">
...
<script type="text/template" id="tmpl-elementor-template-library-save-template">
	...
	<div class="elementor-template-library-blank-footer">
		...
		<a class="elementor-template-library-blank-footer-link" href="https://avanam.org/presta/docs-library/" target="_blank"><?php echo Wp_Helper::__( 'Click here', 'elementor' ); ?></a>
	</div>
</script>
