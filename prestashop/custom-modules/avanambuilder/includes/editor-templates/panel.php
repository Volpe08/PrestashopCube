		...
		<div class="elementor-panel-footer-sub-menu-wrapper">
			<div class="elementor-panel-footer-sub-menu">
				...
				<div class="elementor-panel-footer-sub-menu-item" data-device-mode="laptop">
					<i class="elementor-icon eicon-device-laptop" aria-hidden="true"></i>
					<span class="elementor-title"><?php echo Wp_Helper::__( 'Laptop', 'elementor' ); ?></span>
					<?php $breakpoints = Responsive::get_breakpoints(); ?>
					<span class="elementor-description"><?php echo sprintf( Wp_Helper::__( 'Preview for %s', 'elementor' ), $breakpoints['lg'] . 'px' ); ?></span>
				</div>
