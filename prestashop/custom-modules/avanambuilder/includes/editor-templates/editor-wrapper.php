...
<head>
    ...
    <?php } ?>
	<link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo AVANAM_BUILDER_ASSETS_URL . 'images/favicon.ico'; ?>">
	<link rel="shortcut icon" type="image/x-icon" href="<?php echo AVANAM_BUILDER_ASSETS_URL . 'images/favicon.ico'; ?>">
	<title><?php echo Wp_Helper::__( 'AvanamBuilder', 'elementor' ) . ' | ' . ( Wp_Helper::$post_title ? Wp_Helper::$post_title : '' ); ?></title>
