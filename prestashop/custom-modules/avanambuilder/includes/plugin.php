...
use AvanamBuilder\Core\Admin\Admin;
use AvanamBuilder\Core\Common\Modules\Ajax\Module as Ajax;
use AvanamBuilder\Core\Common\App as CommonApp;
use AvanamBuilder\Core\Debug\Inspector;
use AvanamBuilder\Core\Documents_Manager;
use AvanamBuilder\Core\Editor\Editor;
use AvanamBuilder\Core\Files\Manager as Files_Manager;
use AvanamBuilder\Core\Files\Assets\Manager as Assets_Manager;
use AvanamBuilder\Core\Modules_Manager;
use AvanamBuilder\Core\Settings\Manager as Settings_Manager;
use AvanamBuilder\Core\Settings\Page\Manager as Page_Settings_Manager;
use AvanamBuilder\Core\Revisions\Revisions_Manager;
use AvanamBuilder\Core\DynamicTags\Manager as Dynamic_Tags_Manager;
use AvanamBuilder\Core\Logger\Manager as Log_Manager;
...
class Plugin {
	...
	private function register_autoloader() {
		require AVANAM_BUILDER_PATH . '/includes/autoloader.php';
