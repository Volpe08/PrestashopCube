...
class Tools extends Settings_Page {
	...
	public function post_elementor_rollback() {
		...
		$plugin_slug = basename( AVANAM_BUILDER__FILE__, '.php' );

		$rollback = new Rollback(
			[
				'version' => AVANAM_BUILDER_PREVIOUS_STABLE_VERSION,
				'plugin_name' => AVANAM_BUILDER_PLUGIN_BASE,
				'plugin_slug' => $plugin_slug,
				'package_url' => sprintf( 'https://downloads.wordpress.org/plugin/%s.%s.zip', $plugin_slug, AVANAM_BUILDER_PREVIOUS_STABLE_VERSION ),
			]
		);
								...
								'field_args' => [
									...
									'html' => sprintf(
										...
										sprintf(
											...
											AVANAM_BUILDER_PREVIOUS_STABLE_VERSION
										)
									),
