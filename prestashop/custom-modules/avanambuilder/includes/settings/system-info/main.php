...
namespace AvanamBuilder\System_Info;

use AvanamBuilder\System_Info\Classes\Abstracts\Base_Reporter;
use AvanamBuilder\System_Info\Helpers\Model_Helper;
...
class Main {
	...
	protected function get_default_settings() {
		...
		$base_lib_dir = AVANAM_BUILDER_PATH . 'includes/settings/system-info/';
