...
use AvanamBuilder\Core\Files\Assets\Svg\Svg_Handler;
...
class Icons_Manager {
	...
	private static function init_tabs() {
		self::$tabs = Wp_Helper::apply_filters( 'elementor/icons_manager/native', [
			...
			'line-awesome' => [
				...
				'url' => AVANAM_BUILDER_ASSETS_URL . 'lib/line-awesome/line-awesome.min.css',
				'enqueue' => [],
				'prefix' => 'la-',
				'displayPrefix' => 'la',
				'labelIcon' => 'la la-flag',
				'ver' => '1.3.0',
				'fetchJson' => AVANAM_BUILDER_ASSETS_URL . 'lib/line-awesome/line-awesome.json',
				'native' => true,
			],
			'pe-icon' => [
				'name' => 'pe-icon',
				'label' => Wp_Helper::__( 'Pe Icon', 'elementor' ),
				'url' => AVANAM_BUILDER_ASSETS_URL . 'lib/pe-icon/Pe-icon-7-stroke.min.css',
				'enqueue' => [],
				'prefix' => 'pe-7s-',
				'displayPrefix' => '',
				'labelIcon' => 'pe-7s-flag',
				'ver' => '1.2.0',
				'fetchJson' => AVANAM_BUILDER_ASSETS_URL . 'lib/pe-icon/Pe-icon.json',
				'native' => true,
			],
			'avanam-icon' => [
				'name' => 'avanam-icon',
				'label' => Wp_Helper::__( 'Avanam Icon', 'elementor' ),
				'url' => AVANAM_BUILDER_ASSETS_URL . 'lib/avanam-icon/avanam-icon.css',
				'enqueue' => [],
				'prefix' => 'icon-',
				'displayPrefix' => 'icon-ava',
				'labelIcon' => 'icon icon-earth-2',
				'ver' => '1.0.0',
				'fetchJson' => AVANAM_BUILDER_ASSETS_URL . 'lib/avanam-icon/avanam-icon.json',
				'native' => true,
			],
		] );
	}
	...
	private static function get_fa_asset_url( $filename, $ext_type = 'css', $add_suffix = true ) {
		...
		if ( null === $is_test_mode ) {
			$is_test_mode = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG || defined( 'AVANAM_BUILDER_TESTS' ) && AVANAM_BUILDER_TESTS;
		}
		$url = AVANAM_BUILDER_ASSETS_URL . 'lib/font-awesome/' . $ext_type . '/' . $filename;
	...
	public static function fa4_to_fa5_value_migration( $value ) {
		...
		if ( false === $migration_dictionary ) {
			$migration_dictionary = json_decode( file_get_contents( AVANAM_BUILDER_ASSETS_PATH . 'lib/font-awesome/migration/mapping.json' ), true );
		}
