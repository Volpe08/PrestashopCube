...
class Elements_Manager {
	...
	private function init_categories() {
		$this->categories = [
			...
			'avanam-elements' => [
				'title' => Wp_Helper::__( 'Avanam - Elements', 'elementor' ),
			],
		];
	...
	private function require_files() {
		require_once AVANAM_BUILDER_PATH . 'includes/base/element-base.php';

		require AVANAM_BUILDER_PATH . 'includes/elements/column.php';
		require AVANAM_BUILDER_PATH . 'includes/elements/section.php';
		require AVANAM_BUILDER_PATH . 'includes/elements/repeater.php';
	}
}
