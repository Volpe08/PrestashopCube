...
class Widget_Button extends Widget_Base {
	...
	protected function render() {
		...
		if ( ! empty( $settings['link']['url'] ) ) {
			...
			$this->add_render_attribute( 'button', 'class', 'btn btn-primary elementor-button-link' );
	...
	protected function _content_template() {
		...
		<div class="elementor-button-wrapper">
			<a id="{{ settings.button_css_id }}" class="elementor-button elementor-animation-{{ settings.hover_animation }}" href="{{ settings.link.url }}" role="button">
