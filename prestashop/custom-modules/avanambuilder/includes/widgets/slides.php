...
class Widget_Slides extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default' => Wp_Helper::__( 'Slide Sub Title', 'elementor' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'heading',
			[
				'label' => Wp_Helper::__( 'Heading', 'elementor' ),
				'type' => Controls_Manager::TEXT,
		...
		$repeater->add_control(
			'description_text_1',
			[
				'label' => Wp_Helper::__( 'Description Text 1', 'elementor' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => Wp_Helper::__( 'Description Text 1', 'elementor' ),
				'show_label' => true,
			]
		);
		...
		$repeater->add_control(
			'description_text_2',
			[
				'label' => Wp_Helper::__( 'Description Text 2', 'elementor' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => Wp_Helper::__( 'Description Text 2', 'elementor' ),
				'show_label' => true,
			]
		);
		...
		$repeater->add_control(
			'description_text_3',
			[
				'label' => Wp_Helper::__( 'Description Text 3', 'elementor' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => Wp_Helper::__( 'Description Text 3', 'elementor' ),
				'show_label' => true,
			]
		);
		...
		$repeater->add_control(
			'description_text_4',
			[
				'label' => Wp_Helper::__( 'Description Text 4', 'elementor' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => Wp_Helper::__( 'Description Text 4', 'elementor' ),
				'show_label' => true,
			]
		);
		...
		$repeater->add_control(
			'sub_title_color',
			[
				'label' => Wp_Helper::__( 'Sub Title Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .swiper-slide-inner .elementor-slide-sub-title' => 'color: {{VALUE}}',
				],
				'conditions' => [
					'terms' => [
						[
		...
		$repeater->add_control(
			'description_text_color_1',
			[
				'label' => Wp_Helper::__( 'Description Text Color 1', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .swiper-slide-inner .elementor-slide-description-text-1' => 'color: {{VALUE}}',
				],
				'conditions' => [
					'terms' => [
						[
		...
		$repeater->add_control(
			'description_text_color_2',
			[
				'label' => Wp_Helper::__( 'Description Text Color 2', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .swiper-slide-inner .elementor-slide-description-text-2' => 'color: {{VALUE}}',
				],
				'conditions' => [
					'terms' => [
						[
		...
		$repeater->add_control(
			'description_text_color_3',
			[
				'label' => Wp_Helper::__( 'Description Text Color 3', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .swiper-slide-inner .elementor-slide-description-text-3' => 'color: {{VALUE}}',
				],
				'conditions' => [
					'terms' => [
						[
		...
		$repeater->add_control(
			'description_text_color_4',
			[
				'label' => Wp_Helper::__( 'Description Text Color 4', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .swiper-slide-inner .elementor-slide-description-text-4' => 'color: {{VALUE}}',
				],
				'conditions' => [
					'terms' => [
						[
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .swiper-slide, {{WRAPPER}} .swiper-slide-bg' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'inner_max_width',
			[
				'label' => Wp_Helper::__( 'Content Spacing', 'elementor' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .swiper-slide-inner .elementor-slide-sub-title:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-slide-sub-title' => 'color: {{VALUE}}',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elementor-slide-sub-title',
			]
		);
		...
		$this->start_controls_section(
			'section_style_description_text_1',
			[
				'label' => Wp_Helper::__( 'Description Text 1', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .swiper-slide-inner .elementor-slide-description-text-1:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-slide-description-text-1' => 'color: {{VALUE}}',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'description_typography_text_1',
				'selector' => '{{WRAPPER}} .elementor-slide-description-text-1',
			]
		);
		...
		$this->start_controls_section(
			'section_style_description_text_2',
			[
				'label' => Wp_Helper::__( 'Description Text 2', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .swiper-slide-inner .elementor-slide-description-text-2:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-slide-description-text-2' => 'color: {{VALUE}}',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'description_typography_text_2',
				'selector' => '{{WRAPPER}} .elementor-slide-description-text-2',
			]
		);
		...
		$this->start_controls_section(
			'section_style_description_text_3',
			[
				'label' => Wp_Helper::__( 'Description Text 3', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .swiper-slide-inner .elementor-slide-description-text-3:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-slide-description-text-3' => 'color: {{VALUE}}',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'description_typography_text_3',
				'selector' => '{{WRAPPER}} .elementor-slide-description-text-3',
			]
		);
		...
		$this->start_controls_section(
			'section_style_description_text_4',
			[
				'label' => Wp_Helper::__( 'Description Text 4', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .swiper-slide-inner .elementor-slide-description-text-4:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-slide-description-text-4' => 'color: {{VALUE}}',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'description_typography_text_4',
				'selector' => '{{WRAPPER}} .elementor-slide-description-text-4',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .elementor-slide-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options'     => [
					...
					'hover' => Wp_Helper::__('On Hover', 'elementor'),
				],
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
		...
		$this->add_control(
			'arrows_hover_color',
			[
				'label' => Wp_Helper::__( 'Arrows Hover Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => Wp_Helper::__( 'Arrows BG Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => Wp_Helper::__( 'Arrows BG Hover Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'dots_hover_color',
			[
				'label' => Wp_Helper::__( 'Dots Hover/Active Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .swiper-pagination-bullet-active, .swiper-pagination-bullet:hover' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'navigation' => [ 'dots', 'both' ],
				],
	...
	protected function render() {
		...
		$this->add_render_attribute( 'button', 'class', [ 'elementor-button', 'elementor-slide-button', 'btn', 'btn-primary' ] );
		...
		foreach ( $settings['slides'] as $slide ) {
			...
			if ( $slide['sub_title']) {
				$slide_html .= '<div class="elementor-slide-sub-title">' . $slide['sub_title'] . '</div>';
			}			
			...
			if ( $slide['description_text_1'] ) {
				$slide_html .= '<div class="elementor-slide-description-text-1">' . $slide['description_text_1'] . '</div>';
			}

			if ( $slide['description_text_2'] ) {
				$slide_html .= '<div class="elementor-slide-description-text-2">' . $slide['description_text_2'] . '</div>';
			}

			if ( $slide['description_text_3'] ) {
				$slide_html .= '<div class="elementor-slide-description-text-3">' . $slide['description_text_3'] . '</div>';
			}

			if ( $slide['description_text_4'] ) {
				$slide_html .= '<div class="elementor-slide-description-text-4">' . $slide['description_text_4'] . '</div>';
			}
		...
		<div class="elementor-swiper">
			<div class="elementor-slides-wrapper elementor-main-swiper swiper-container arrow-<?php echo $settings['slider_arrows_show']; ?>" dir="<?php echo $direction; ?>" data-animation="<?php echo $settings['content_animation']; ?>">
						...
						<div class="elementor-repeater-item-{{ slide._id }} swiper-slide">
							...
							<div class="swiper-slide-inner">
								<div class="swiper-slide-contents">
									<# if ( slide.sub_title ) { #>
										<div class="elementor-slide-sub-title">{{{ slide.sub_title }}}</div>
									<# }
									if ( slide.heading ) { #>
									...
									<# }
									if ( slide.description_text_1 ) { #>
										<div class="elementor-slide-description-text-1">{{{ slide.description_text_1 }}}</div>
									<# }
									if ( slide.description_text_2 ) { #>
										<div class="elementor-slide-description-text-2">{{{ slide.description_text_2 }}}</div>
									<# }
									if ( slide.description_text_3 ) { #>
										<div class="elementor-slide-description-text-3">{{{ slide.description_text_3 }}}</div>
									<# }
									if ( slide.description_text_4 ) { #>
										<div class="elementor-slide-description-text-4">{{{ slide.description_text_4 }}}</div>
									<# }
									if ( slide.button_text ) { #>
										<div class="elementor-button elementor-slide-button">{{{ slide.button_text }}}</div>
									<# } #>
								</div>
							</div>
						</div>
