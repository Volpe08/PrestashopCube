 ...
 * @since 1.0.0
 */
class Widget_Ava_Image extends Widget_Base {
	...
	protected function _register_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ava-swiper-slider .swiper-slide img' => 'width: {{VALUE}};',
				],
			]
		);
	...
	protected function _register_styling_controls() {
		...
		$this->start_controls_section(
			'item_inner',
			[
				'label' => Wp_Helper::__( 'Item Inner', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);

		$this->add_control(
			'item_inner_background_color',
			[
				'label' => Wp_Helper::__( 'Background Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .item-inner' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'item_inner_border_radius',
			[
				'label' => Wp_Helper::__( 'Border Radius', 'elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .item-inner' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .item-inner' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'text_hover_color',
			[
				'label' => Wp_Helper::__( 'Text Hover Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .widget-image-caption:hover' => 'color: {{VALUE}};'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .widget-image-caption' => 'background-color: {{VALUE}}; transition:0.2s all;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => Wp_Helper::__( 'Background Hover Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .widget-image-caption:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .widget-image-content' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .widget-image-content' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .widget-image-content',
				'scheme' => Scheme_Typography::TYPOGRAPHY_3,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .widget-image-content' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => Wp_Helper::__( 'Button Style', 'elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .button:has(.widget-image-button-text)' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .widget-image-button-text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .widget-image-button-text' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'button_hover_color',
			[
				'label' => Wp_Helper::__( 'Hover Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} a:hover .widget-image-button-text' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} a:hover .widget-image-button-text' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .widget-image-button-text',
				'scheme' => Scheme_Typography::TYPOGRAPHY_3,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .widget-image-button-text' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .widget-image-button-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .widget-image-button-text' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		foreach ( $settings['items'] as $index => $item ) {
			...
			if (!empty($item['content_des'])) {
				$content = '<div class="widget-image-content">' . $item['content_des'] . '</div>';
			}

			if (!empty($item['button_text'])) {
				$button_text = '<div class="widget-image-button-text btn btn-primary">' . htmlspecialchars($item['button_text'], ENT_QUOTES, 'UTF-8') . '</div>';
			}
			...
			if ( $link ) {
				...
				$image_html = '<div class="image"><a ' . $this->get_render_attribute_string( $link_key ) . ' data-elementor-open-lightbox="' . $item['open_lightbox'] . '" data-elementor-lightbox-slideshow="'. $this->get_id() . '" data-elementor-lightbox-index="'. $index .'">' . $image_html . '</a></div>
				<div class="cat-des">
					<div class="title"><a ' . $this->get_render_attribute_string( $link_key ) . '>' . $caption . '</a></div>
					<div class="cat-content">' . $content . '</div>
					<div class="button"><a ' . $this->get_render_attribute_string( $link_key ) . '>' . $button_text . '</a></div>
				</div>';

			} else {
				$image_html = '<div class="image">' . $image_html . '</div>
				<div class="cat-des">
	...
	protected function _render_view_setting_attributes( $settings, $attr_class_section = [], $attr_class_wrapper = [] ) {
		...
		$attr_class_wrapper[] = 'cat-style-' . $settings['style'];
	...
	protected function _register_view_settings_controls() {
		...
		$category_style = [];
		for( $i = 1; $i <= 6; $i++ ){
			$category_style[$i] = Wp_Helper::__( 'Style ' . $i, 'elementor' );
		}
		...
		$this->add_responsive_control(
			...
			[
				...
				'tablet_default' => 20,
				'mobile_default' => 10,
				'options'     => [ 0 => 0, 5 => 5, 10 => 10, 15 => 15, 20 => 20, 25 => 25, 30 => 30, 35 => 35, 40 => 40, 45 => 45, 50 => 50, 55 => 55, 60 => 60, 65 => 65, 70 => 70, 75 => 75, 80 => 80, 85 => 85, 90 => 90, 95 => 95, 100 => 100, 110 => 110, 120 => 120, 130 => 130, 140 => 140, 150 => 150, 160 => 160, 170 => 170, 180 => 180, 190 => 190, 200 => 200 ],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ava-swiper-slider .swiper-dots .swiper-pagination-bullet::before' => 'left: {{SIZE}}{{UNIT}}; bottom: {{SIZE}}{{UNIT}}; top: {{SIZE}}{{UNIT}}; right: {{SIZE}}{{UNIT}};'
					],
				]
			);	
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'type' => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ava-swiper-slider .swiper-dots .swiper-pagination-bullet::before' => 'background-color: {{VALUE}};',
							],
						]
					);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'type' => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ava-swiper-slider .swiper-dots .swiper-pagination-bullet:hover::before, {{WRAPPER}} .ava-swiper-slider .swiper-dots .swiper-pagination-bullet.swiper-pagination-bullet-active::before' => 'background-color: {{VALUE}};',
							],
						]
					);
