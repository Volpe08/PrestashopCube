 ...
 * @since 1.0.0
 */
class Widget_Ava_Testimonial extends Widget_Base {
	...
	protected function _register_content_controls() {
		...
		$this->add_control(
			'testimonial_rating',
			[
				'label'        => Wp_Helper::__( 'Show rating', 'elementor' ),
		...
		$this->add_control(
			'testimonial_icon',
			[
				'label'        => Wp_Helper::__( 'Show quote icon', 'elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => Wp_Helper::__( 'Yes', 'elementor' ),
				'label_off'    => Wp_Helper::__( 'No', 'elementor' ),
			]
	...
	protected function _register_styling_controls() {
		...
		// item content 
		$this->start_controls_section(
			'section_style_testimonial_item_content',
			[
				'label' => Wp_Helper::__( 'Item Content', 'elementor' ),
		...
		$this->add_control(
			'item_content_bg',
			[
				'label' => Wp_Helper::__( 'Item Content BG', 'elementor' ),
		...
		$this->add_group_control(
			...
			[
				'name' => 'border',
				'selector' => '{{WRAPPER}} .item .item-content',
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .item .item-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .item .item-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-testimonial-wrapper .elementor-testimonial-content' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		// Heading.
		$this->start_controls_section(
			'section_style_testimonial_heading',
			[
				'label' => Wp_Helper::__( 'Heading', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-testimonial-heading' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elementor-testimonial-heading',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-testimonial-wrapper .elementor-testimonial-heading' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-testimonial-name, .elementor-testimonial-name a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-testimonial-name:hover, .elementor-testimonial-name a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-testimonial-job, .elementor-testimonial-job a' => 'color: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'job_text_hover_color',
			[
				'label' => Wp_Helper::__( 'Text Hover Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => [
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-testimonial-job:hover, .elementor-testimonial-job a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-testimonial-wrapper .elementor-testimonial-job' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-testimonial-wrapper .grade-stars' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .quote-icon .icon:before' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-testimonial-wrapper .quote-icon .icon' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-testimonial-wrapper .quote-icon' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
            ...
            <div<?php echo $attrs['attr_class_wrapper']; ?><?php echo $attrs['attr_slider_options']; ?>>
				<div class="swiper-wrapper">
					<?php foreach ( $settings['items'] as $index => $item ) {
						...
						$has_heading = ! ! $item['testimonial_heading'];
						...
						echo $settings['testimonial_rating'] ? '<div class="grade-stars" data-grade="5"><div class="star-content star-empty clearfix"><div class="star" style="visibility: hidden;"></div><div class="star" style="visibility: hidden;"></div><div class="star" style="visibility: hidden;"></div><div class="star" style="visibility: hidden;"></div><div class="star" style="visibility: hidden;"></div></div><div class="star-content star-full clearfix"><div class="star-on"></div><div class="star-on"></div><div class="star-on"></div><div class="star-on"></div><div class="star-on"></div></div></div>' : '';
						echo $settings['testimonial_icon'] ?  '<div class="quote-icon"><span class="icon-inner"><i class="icon icon-ava icon-quote-left"></i></span></div>' : '';

						if ( $has_heading ) :
							echo '<div class="elementor-testimonial-heading">' . $item['testimonial_heading'] . '</div>';
						endif;
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .wrapper-items .swiper-slide .item-content' => 'margin-bottom: calc(2*{{VALUE}}px/2);',
