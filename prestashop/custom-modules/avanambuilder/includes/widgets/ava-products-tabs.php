 ...
 * @since 1.0.0
 */
class Widget_Ava_Products_Tabs extends Widget_Base {
	...
	protected function _register_content_controls() {
		...
		$repeater = new Repeater();
			...
			$repeater->add_control(
				'icon_type',
				[
					'label' => Wp_Helper::__( 'Icon Type', 'elementor' ),
	...
	protected function _register_styling_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					'label' => Wp_Helper::__('Tab', 'elementor'),
					'type' => Controls_Manager::HEADING
				]
			);		
			...
			$this->add_control(
				...
				[
					'label' => Wp_Helper::__('Icon/Image', 'elementor'),
					'type' => Controls_Manager::HEADING,
					'separator' => 'before'
				]
			);
			...
			$this->add_responsive_control(
				'item_icon_size',
				[
					'label' => Wp_Helper::__( 'Icon/Image Size', 'elementor' ),
        ...
        $this->start_controls_section(
			...
			[
				'label' => Wp_Helper::__( 'Tabs Content', 'elementor' ),
				'type' => Controls_Manager::SECTION,
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
            ...
            <div class="widget-tabs-content-wrapper">
                <?php foreach ($items as $item) : ?>
                    ...
                    <div class="widget-tab-content<?php if( $counter < 2 ){ echo ' active'; } ?>" data-tab="<?php echo $counter++; ?>">
						<?php $attrs = $this->_render_view_setting_attributes( $item_settings, [ 'products' ], [] ); ?>
							...
							<?php /* }elseif( $settings['view_type'] == 'grid' && $item_settings['load_more'] && $item_settings['source'] != 's' ) { ?>
								<div class="ajax-load-wrapper">
									<div class="ajax-load-button">
										<div class="btn btn-primary widget-ajax-trigger">
                                            <?php echo $context->getTranslator()->trans('More Products', [], 'Shop.Theme.Global'); ?>
										</div>
										<div class="btn btn-primary ajax-loader" style="display:none;">
