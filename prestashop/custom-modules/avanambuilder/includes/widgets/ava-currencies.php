 ...
 * @since 1.0.0
 */
class Widget_Ava_Currencies extends Widget_Base {
	...
	public function get_title() {
		return Wp_Helper::__( 'Currencies', 'elementor' );
	}
	...
	protected function render() {
		...
		echo $context->smarty->fetch('module:avanambuilder/views/templates/widgets/currencies.tpl');
	}
}