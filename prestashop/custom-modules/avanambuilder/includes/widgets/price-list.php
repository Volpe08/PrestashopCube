...
class Widget_Price_List extends Widget_Base {
	...
	public function get_keywords() {
		return [ 'pricing', 'list', 'product', 'image', 'menu', 'ava' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-price-list-header .elementor-price-list-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-price-list-item:hover .elementor-price-list-header .elementor-price-list-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elementor-price-list-header .elementor-price-list-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-price-list-header .elementor-price-list-price' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-price-list-item:hover .elementor-price-list-header .elementor-price-list-price' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elementor-price-list-header .elementor-price-list-price',
			]
		);
