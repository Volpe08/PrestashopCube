	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'hide_in_inner' => true,
				'description' => Wp_Helper::__( 'Stretch the section to the full width of the page using JS.', 'elementor' ) . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'https://avanam.org/presta/stretch-section/', Wp_Helper::__( 'Learn more.', 'elementor' ) ),
				'render_type' => 'none',
		...
		$this->add_control(
			'reverse_order_laptop',
			[
				'label' => Wp_Helper::__( 'Reverse Columns', 'elementor' ) . ' (' . Wp_Helper::__( 'Laptop', 'elementor' ) . ')',
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'prefix_class' => 'elementor-',
				'return_value' => 'reverse-laptop',
			]
		);
		...
		$this->add_control(
			'hide_laptop',
			[
				'label' => Wp_Helper::__( 'Hide On Laptop', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'prefix_class' => 'elementor-',
				'label_on' => Wp_Helper::__( 'Hide', 'elementor' ),
