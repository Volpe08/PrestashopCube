...
final class _WP_Editors {
	...
	public static function enqueue_scripts( $default_scripts = false ) {
		...
		echo '<script src="' . AVANAM_BUILDER_ASSETS_URL . 'lib/wp-editor/editor' . $suffix . '.js"></script>' . PHP_EOL;
		echo '<script src="' . AVANAM_BUILDER_ASSETS_URL . 'lib/wp-editor/utils.min.js"></script>' . PHP_EOL;
		echo '<script src="' . AVANAM_BUILDER_ASSETS_URL . 'lib/wp-editor/quicktags' . $suffix . '.js"></script>' . PHP_EOL;
		echo '<link rel="stylesheet" href="' . AVANAM_BUILDER_ASSETS_URL . 'lib/wp-editor/editor' . $suffix . '.css' . '" media="all" />' . PHP_EOL;
		echo '<link rel="stylesheet" href="' . AVANAM_BUILDER_ASSETS_URL . 'lib/wp-editor/skin.min.css' . '" media="all" />' . PHP_EOL;
	}
