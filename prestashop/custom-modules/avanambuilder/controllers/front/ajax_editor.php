...
class AvanamBuilderAjax_EditorModuleFrontController extends ModuleFrontController {
	
    public function init() {
        parent::init();
		
		Wp_Helper::add_action( 'wp_ajax_ava_get_products_title_by_id', [ $this, 'ava_get_products_title_by_id' ] );
		Wp_Helper::add_action( 'wp_ajax_ava_get_products_by_query', [ $this, 'ava_get_products_by_query' ] );
    }
	...
	public function ava_get_products_title_by_id() {
    ...
    public function ava_get_products_by_query() {
		header('Content-Type: application/json');
