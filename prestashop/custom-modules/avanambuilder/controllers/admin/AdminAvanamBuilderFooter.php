...
class AdminAvanamBuilderFooterController extends ModuleAdminController
{
    public $name;
    ...
    public function __construct()
    {
            ...
            'general' => array(
                ...
                'fields' =>    array(
                    'active_footer_layout' => array(
                        'title' => $this->trans('Footer layout', [], 'Modules.Avanambuilder.Admin'),
                        'desc' => $this->trans('Choose your footer layout. You can create multiple layouts in list above. So you can change them fast when needed.', [], 'Modules.Avanambuilder.Admin'),
                        'cast' => 'intval',
                        'type' => 'select',
        ...
        $this->name = 'AdminAvanamBuilderFooter';
    }
	
    public function initToolBarTitle()
    {
        $this->toolbar_title[] = $this->trans('Avanam - Footer', [], 'Modules.Avanambuilder.Admin');
    }
    ...
    public function renderForm()
    {
        ...
        if ($obj->id){
            $url = $this->context->link->getAdminLink('AvanamBuilderEditor').'&post_type=footer&id_post=' . $obj->id . '&id_lang='. $id_lang;
        }
        else{
            $url = false;
        }
