...
class AdminAvanamBuilderHeaderController extends ModuleAdminController
{
    public $name;
    ...
    public function __construct()
    {
            ...
            'general' => array(
                ...
                'fields' =>    array(
                    'active_header_layout' => array(
                        'title' => $this->trans('Header layout', [], 'Modules.Avanambuilder.Admin'),
                        'desc' => $this->trans('Choose your header layout. You can create multiple layouts in list above. So you can change them fast when needed.', [], 'Modules.Avanambuilder.Admin'),
                        'cast' => 'intval',
                        'type' => 'select',
                    ...
                    //     'title' => $this->trans('Header sticky layout', [], 'Modules.Avanambuilder.Admin'),
                    //     'cast' => 'intval',
                    //     'type' => 'select',
                    //     'list' => array_merge($list_pages, $this->module->getListByPostType('header')),
                    //     'identifier' => 'id'
        ...
        $this->name = 'AdminAvanamBuilderHeader';
    }
	
    public function initToolBarTitle()
    {
        $this->toolbar_title[] = $this->trans('Avanam - Header', [], 'Modules.Avanambuilder.Admin');
    }
    ...
    public function renderForm()
    {
        ...
        if ($obj->id){
            $url = $this->context->link->getAdminLink('AvanamBuilderEditor').'&post_type=header&id_post=' . $obj->id . '&id_lang='. $id_lang;
        }
        else{
            $url = false;
        }
