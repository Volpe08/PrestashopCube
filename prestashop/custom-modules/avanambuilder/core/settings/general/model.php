...
namespace AvanamBuilder\Core\Settings\General;
				...
				'style' => [
					...
					'controls' => [
						...
						'elementor_page_title_selector' => [
							...
							'description' => Wp_Helper::__( 'AvanamBuilder lets you hide the page title. This works for themes that have "h1.entry-title" selector. If your theme\'s selector is different, please enter it above.', 'elementor' ),
							'label_block' => true,
						],
					],
				],
