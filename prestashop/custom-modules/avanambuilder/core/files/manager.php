...
namespace AvanamBuilder\Core\Files;

use AvanamBuilder\Core\Files\CSS\Global_CSS;
use AvanamBuilder\Core\Files\CSS\Post as Post_CSS;
use AvanamBuilder\Core\Files\Svg\Svg_Handler;
use AvanamBuilder\Core\Responsive\Files\Frontend;
...
class Manager {
	...
	public function clear_cache() {
		...
		\Module::getInstanceByName('avanambuilder')->clearGlobalCssCache();
