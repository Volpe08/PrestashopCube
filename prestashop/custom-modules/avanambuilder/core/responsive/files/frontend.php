...
namespace AvanamBuilder\Core\Responsive\Files;

use AvanamBuilder\Core\Files\Base;
...
class Frontend extends Base {
	...
	public function parse_content() {
		...
		$file_content = preg_replace_callback( '/AVANAM_BUILDER_SCREEN_([A-Z]+)_([A-Z]+)/', function ( $placeholder_data ) use ( $breakpoints_keys, $breakpoints ) {
