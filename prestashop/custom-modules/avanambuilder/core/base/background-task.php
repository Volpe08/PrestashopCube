...
include_once AVANAM_BUILDER_PATH . '/includes/libraries/wp-background-process/wp-async-request.php';
include_once AVANAM_BUILDER_PATH . '/includes/libraries/wp-background-process/wp-background-process.php';
...
abstract class Background_Task extends \WP_Background_Process {
	...
	public function schedule_cron_healthcheck( $schedules ) {
		...
		$schedules[ $this->identifier . '_cron_interval' ] = array(
			'interval' => AVANAM_MINUTE_IN_SECONDS * $interval,
