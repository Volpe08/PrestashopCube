...
namespace AvanamBuilder\Core\Base;
...
use AvanamBuilder\Controls_Manager;
...
abstract class Document extends Controls_Stack {
	...
	public function get_elements_data( $status = DB::STATUS_PUBLISH ) {
		$obj =  new \AvanamBuilderPost( Wp_Helper::$id_post, Wp_Helper::$id_lang );
	...
	public function save_version() {
		if ( ! defined( 'IS_AVANAM_BUILDER_UPGRADE' ) ) {
			// Save per revision.
			$this->update_meta( '_elementor_version', AVANAM_BUILDER_VERSION );
