...
namespace AvanamBuilder\Core\Common;

use AvanamBuilder\Core\Base\App as BaseApp;
use AvanamBuilder\Core\Common\Modules\Ajax\Module as Ajax;
use AvanamBuilder\Core\Common\Modules\Connect\Module as Connect;
...
class App extends BaseApp {
	...
	private function add_default_templates() {
		...
		foreach ( $default_templates as $template ) {
			$this->add_template( AVANAM_BUILDER_PATH . $template );
		}
	}
}