...
namespace AvanamBuilder\Core\RoleManager;

use AvanamBuilder\Settings_Page;
...
class Role_Manager extends Settings_Page {
	...
	public function get_go_pro_link_html() {
		$pro_link = Utils::get_pro_link( 'https://avanam.org/presta/pro/?utm_source=wp-role-manager&utm_campaign=gopro&utm_medium=wp-dash' );
		?>
