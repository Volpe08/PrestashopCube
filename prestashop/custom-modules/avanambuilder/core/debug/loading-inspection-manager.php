...
namespace AvanamBuilder\Core\Debug;

use AvanamBuilder\Core\Debug\Classes\Inspection_Base;
use AvanamBuilder\Core\Debug\Classes\Theme_Missing;
use AvanamBuilder\Core\Debug\Classes\Htaccess;
...
class Loading_Inspection_Manager {
	...
	public function run_inspections() {
		$debug_data = [
			...
			'doc_url' => 'https://avanam.org/presta/preview-not-loaded/',
		];
