...
namespace AvanamBuilder\Core\Logger;

use AvanamBuilder\Core\Base\Module as BaseModule;
use AvanamBuilder\Core\Common\Modules\Ajax\Module;
use AvanamBuilder\Core\Logger\Loggers\Logger_Interface;
use AvanamBuilder\Core\Logger\Items\PHP;
use AvanamBuilder\Core\Logger\Items\JS;
use AvanamBuilder\Plugin;
use AvanamBuilder\System_Info\Main as System_Info;
...
class Manager extends BaseModule {
	...
	public function shutdown() {
		...
		$elementor_path = untrailingslashit( wp_normalize_path( AVANAM_BUILDER_PATH ) );
